...
public class FTsearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String query=request.getParameter("queries");
           ...
           Query qu=new Query("/Users/wuhao/Desktop/Infromation Retrieval&Storage/Final Project/indexFloder",query);
           List<SearchResult> results=qu.run();
           PostContent pcontent=new PostContent("/Users/wuhao/Desktop/Infromation Retrieval&Storage/Final Project/collection_original.txt" );
